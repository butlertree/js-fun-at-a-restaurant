...
if(isFavorite === true){
    console.log(`My favoriet food is ${food}!`)
} else {
...
var vegetables = ['carrots', 'corn', 'lettuce', 'broccoli', 'spinach']
...
var fruits =['apple', 'orange', 'strawberry', 'pear', 'peach', 'rasberry', 'bannana']
